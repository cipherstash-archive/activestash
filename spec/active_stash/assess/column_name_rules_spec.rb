RSpec.describe ActiveStash::Assess::ColumnNameRules do
  describe ".check" do
    [
      ...
      ["access_token", "OAuth tokens", "AS0001"],
      ["refresh_token", "OAuth tokens", "AS0001"],
      ["ip", "IP addresses", "AS0001"],
      ["ip_address", "IP addresses", "AS0001"],
      ["ccn", "credit card numbers", "AS0001"],
      ["credit_card_number", "credit card numbers", "AS0001"],
      ...
      ["tfn", "tax file numbers", "AS0001"],
      ["tax_file_number", "tax file numbers", "AS0001"],
      ["medicare_number", "medicare numbers", "AS0001"],
